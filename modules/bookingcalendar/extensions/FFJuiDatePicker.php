...
EOD;
		...
		$this->options['beforeShowDay'] = Booking::getJsCode();
        ...
        if (isset($this->language) && $this->language != 'en'){
            ...
            $js = "jQuery('#{$id}').datepicker(jQuery.extend({showMonthAfterYear:false}, jQuery.datepicker.regional['".Yii::app()->controller->datePickerLang."'], {$options}));";
        }
