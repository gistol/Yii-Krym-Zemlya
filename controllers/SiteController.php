...
//			}
	...
	public function actionGetMarkersViewAllMap() {
		...
		$filterPriceType = (int)$_POST['filterPriceType'];
		$filterObjType = (int)$_POST['filterObjType'];
		...
		$apartments = ViewallonmapWidget::getViewAllMapApartments($filterPriceType, $filterObjType, array(), $addCondition, ViewallonmapWidget::MAX_RESULT);
